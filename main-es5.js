...
var SaleOrder = /** @class */ (function () {
    function SaleOrder(sale_id, table_name, status, sale_date, total_sale, tip, rut) {
...
var PayOrderDialogComponent = /** @class */ (function () {
    function PayOrderDialogComponent(dialogRef, data) {
        this.dialogRef = dialogRef;
        this.data = data;
    }
    PayOrderDialogComponent.prototype.ngOnInit = function () {
    };
    PayOrderDialogComponent.prototype.onNoClick = function () {
        this.dialogRef.close();
    };
    PayOrderDialogComponent.ctorParameters = function () { return [
    ...
    return PayOrderDialogComponent;
}());
...
var PayOrderComponent = /** @class */ (function () {
    function PayOrderComponent(formBuilder, router, dialog, salesService) {
    ...
    PayOrderComponent.prototype.getPendingOrder = function () {
        var _this = this;
        this.salesService.getPendingOrder().subscribe(function (data) {
            ...
            console.log('saleOrderPending: ' + JSON.stringify(_this.saleOrderPending));
        });
    };
    PayOrderComponent.prototype.getPayTip = function (order) {
        order.tip = 0;
        if (this.payTip) {
            order.tip = order.total_sale * 0.10;
        }
    };
    PayOrderComponent.prototype.openDialog = function (order) {
        var _this = this;
        var dialogRef = this.dialog.open(_pay_order_dialog_pay_order_dialog_component__WEBPACK_IMPORTED_MODULE_8__["PayOrderDialogComponent"], {
            width: '300px',
            data: {}
        });
        dialogRef.afterClosed().subscribe(function (rut) {
            console.log('The dialog was closed ' + rut);
            _this.sendSaleOrder(order, rut);
        });
    };
    PayOrderComponent.prototype.sendSaleOrder = function (order, rut) {
        var _this = this;
        var saleOrder = new _models_sale_order_model__WEBPACK_IMPORTED_MODULE_5__["SaleOrder"]();
        saleOrder = order;
        saleOrder.rut = rut;
        this.salesService.putSaleOrder(saleOrder).subscribe(function (response) {
    ...
    PayOrderComponent.ctorParameters = function () { return [
...
module.exports = ".autocomplete {\r\n   width: 100%;\r\n}\r\n\r\n.mat-option {\r\n    font-size: 13px !important;\r\n}\r\n\r\n.card-header {\r\n    background-color: #3f51b5;\r\n}\r\n\r\n.groove {\r\n\r\n    border: 4px solid #eea13c;\r\n    background: #eebe3c;\r\n}\r\n\r\n.restaurant-table{\r\n    padding-left: 10px;\r\n    padding-bottom: 10px;\r\n}\r\n\r\n.location1{\r\n    height: auto;\r\n}\r\n\r\n.location2{\r\n    height: auto;\r\n}\r\n\r\n.location3{\r\n    height: auto;\r\n}\r\n\r\n.location4{\r\n    height: auto;\r\n}\r\n\r\n/* Drag & drop*/\r\n\r\n.drag-drop-container {\r\n    width: 100%;\r\n    display: inline-block;\r\n    vertical-align: top;\r\n  }\r\n\r\n.drag-drop-list {\r\n    border: solid 1px #f6fcff;\r\n    background: #84bbf33f;\r\n    border-radius: 4px;\r\n    overflow: hidden;\r\n    display: block;\r\n  }\r\n\r\n.drag-drop-box {\r\n    padding: 0.75rem; \r\n    border-bottom: solid 1px #f6fcff;\r\n    color: #6c7ac8;\r\n    display: flex;\r\n    flex-direction: row;\r\n    align-items: center;\r\n    justify-content: space-between;\r\n    box-sizing: border-box;\r\n    cursor: move;\r\n    background: #84bbf33f;\r\n    font-size: 12px;\r\n    font-weight: bold;\r\n  }\r\n\r\n/*  css imagen */\r\n\r\n@media (max-width: 575.98px) {\r\n  .local{\r\n    position:absolute;\r\n    background-color: #964778;         \r\n  }\r\n  .img-responsive{\r\n    background-image: url('local1.png');\r\n    background-repeat: no-repeat;    \r\n    width: 500px;  \r\n    height: 800px;\r\n  } \r\n  .chairs{\r\n    height: 260px;\r\n    padding-left: 90px;    \r\n    padding-top: 30px;   \r\n  }\r\n  .chair{\r\n    background: url('chair.png');  \r\n    background-repeat: no-repeat;\r\n    width: 50px;  \r\n    height: 50px;     \r\n  }\r\n  .chair:hover {\r\n    background-color: yellow;\r\n  }\r\n  .tables{\r\n    width: 258px;\r\n    height: 530px; \r\n    padding-left: 40px;  \r\n  }  \r\n  .table{\r\n    background: url('table.png');  \r\n    background-repeat: no-repeat;\r\n    width: 64px;  \r\n    height: 64px;   \r\n    padding-bottom: 90px;  \r\n  } \r\n   \r\n}\r\n\r\n@media (min-width: 576px) and (max-width: 767.98px) {\r\n  .local{\r\n    position:absolute;\r\n    background-color: #964778;         \r\n  }\r\n  .img-responsive{\r\n    background-image: url('local1.png');\r\n    background-repeat: no-repeat;    \r\n    width: 500px;  \r\n    height: 800px;\r\n  } \r\n  .chairs{\r\n    height: 260px;\r\n    padding-left: 270px;    \r\n    padding-top: 30px;   \r\n  }\r\n  .chair{\r\n    background: url('chair.png');  \r\n    background-repeat: no-repeat;\r\n    width: 50px;  \r\n    height: 50px;     \r\n  }\r\n  .tables{\r\n    width: 258px;\r\n    height: 530px; \r\n    padding-left: 40px;  \r\n  }  \r\n  .table{\r\n    background: url('table.png');  \r\n    background-repeat: no-repeat;\r\n    width: 64px;  \r\n    height: 64px;   \r\n    padding-bottom: 90px;  \r\n  } \r\n    \r\n}\r\n\r\n@media (min-width: 768px) and (max-width: 991.98px) {\r\n  .local{\r\n    position:absolute;\r\n    background-color: #964778;         \r\n  }\r\n  .img-responsive{\r\n    background-image: url('local1.png');\r\n    background-repeat: no-repeat;    \r\n    width: 500px;  \r\n    height: 800px;\r\n  } \r\n  .chairs{\r\n    height: 260px;\r\n    padding-left: 270px;    \r\n    padding-top: 30px;   \r\n  }\r\n  .chair{\r\n    background: url('chair.png');  \r\n    background-repeat: no-repeat;\r\n    width: 50px;  \r\n    height: 50px;     \r\n  }\r\n  .tables{\r\n    width: 258px;\r\n    height: 530px; \r\n    padding-left: 40px;  \r\n  }  \r\n  .table{\r\n    background: url('table.png');  \r\n    background-repeat: no-repeat;\r\n    width: 64px;  \r\n    height: 64px;   \r\n    padding-bottom: 90px;  \r\n  } \r\n\r\n}\r\n\r\n@media (min-width: 992px) and (max-width: 1199.98px) {\r\n  .local{\r\n    position:absolute;\r\n    background-color: #964778;         \r\n  }\r\n  .img-responsive{\r\n    background-image: url('local1.png');\r\n    background-repeat: no-repeat;    \r\n    width: 500px;  \r\n    height: 800px;\r\n  } \r\n  .chairs{\r\n    height: 260px;\r\n    padding-left: 270px;    \r\n    padding-top: 30px;   \r\n  }\r\n  .chair{\r\n    background: url('chair.png');  \r\n    background-repeat: no-repeat;\r\n    width: 50px;  \r\n    height: 50px;     \r\n  }\r\n  .tables{\r\n    width: 258px;\r\n    height: 530px; \r\n    padding-left: 40px;  \r\n  }  \r\n  .table{\r\n    background: url('table.png');  \r\n    background-repeat: no-repeat;\r\n    width: 64px;  \r\n    height: 64px;   \r\n    padding-bottom: 90px;  \r\n  } \r\n \r\n}\r\n\r\n@media (min-width: 1200px) {\r\n  .local{\r\n    position:absolute;\r\n    background-color: #964778;         \r\n  }\r\n  .img-responsive{\r\n    background-image: url('local1.png');\r\n    background-repeat: no-repeat;    \r\n    width: 500px;  \r\n    height: 800px;\r\n  } \r\n  .chairs{\r\n    height: 260px;\r\n    padding-left: 270px;    \r\n    padding-top: 30px;\r\n  }\r\n  .chair{\r\n    background: url('chair.png');  \r\n    background-repeat: no-repeat;\r\n    width: 50px;  \r\n    height: 50px;         \r\n  }\r\n\r\n  .tables{\r\n    width: 258px;\r\n    height: 530px; \r\n    padding-left: 40px;  \r\n  }  \r\n  .table{\r\n    background: url('table.png');  \r\n    background-repeat: no-repeat;\r\n    width: 64px;  \r\n    height: 64px;   \r\n    padding-bottom: 90px;  \r\n  } \r\n \r\n}\r\n\r\n/*  button action */\r\n\r\n.button:hover {\r\n  background-color: #ffffff31;  \r\n  transform: translateY(4px);\r\n}\r\n\r\n.button p {\r\n  color: #c6c86c;\r\n  font-weight: bold;\r\n  padding-top: 26px;\r\n}\r\n\r\n.trash{\r\n  background: url('trash.png');  \r\n  background-repeat: no-repeat;\r\n  width: 50px;  \r\n  height: 50px;  \r\n  margin-left: 25px;\r\n}\r\n\r\n.drag-drop-box:last-child {\r\n    border: none;\r\n  }\r\n\r\n.drag-drop-trash {\r\n    margin: 10px;\r\n    min-height: 50px;\r\n    width: 100px;\r\n    border: solid 1px #df7e00;\r\n    background: #e7bc2f;\r\n    border-radius: 6px;\r\n    overflow: hidden;\r\n    display: block;\r\n    text-align: center;    \r\n    color: #646464e3;\r\n    font-weight: bold;\r\n    font-size: 17px;\r\n    font-style: oblique;\r\n  }\r\n\r\n.cdk-drag-preview {\r\n    box-sizing: border-box;\r\n    border-radius: 4px;\r\n    box-shadow: 0 5px 5px -3px rgba(0, 0, 0, 0.2),\r\n                0 8px 10px 1px rgba(0, 0, 0, 0.14),\r\n                0 3px 14px 2px rgba(0, 0, 0, 0.12);\r\n  }\r\n\r\n.cdk-drag-placeholder {\r\n    opacity: 0;\r\n  }\r\n\r\n.cdk-drag-animating {\r\n    transition: transform 250ms cubic-bezier(0, 0, 0.2, 1);\r\n  }\r\n\r\n.drag-drop-list.cdk-drop-list-dragging .drag-drop-box:not(.cdk-drag-placeholder) {\r\n    transition: transform 250ms cubic-bezier(0, 0, 0.2, 1);\r\n  }\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var SalesService = /** @class */ (function () {
    ...
    SalesService.prototype.putSaleOrder = function (saleOrder) {
